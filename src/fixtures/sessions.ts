...
export const MOCK_SESSIONS: Session[] = [
  {
    ...
    status: 'polling',
    timeframeLabel: 'This weekend',
    activityTypes: ['Dinner', 'Drinks'],
...
Alex: Silver Lake sounds good. What about that new place on Sunset?`,
  ...
  },
  {
    ...
    status: 'draft',
    timeframeLabel: 'Next weekend',
    activityTypes: ['Beach', 'Outdoor'],
  ...
  },
  {
    ...
    title: 'Game Night',
    status: 'finalized',
    timeframeLabel: 'Last Friday',
    activityTypes: ['Game Night'],
    createdBy: 'user-2',
  ...
  },
  {
    ...
    status: 'summarized',
    timeframeLabel: 'This Sunday',
    activityTypes: ['Hiking', 'Outdoor'],
