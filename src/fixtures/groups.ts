...
export const MOCK_GROUPS: Group[] = [
  {
    ...
    avatarUrl: 'https://api.dicebear.com/9.x/shapes/svg?seed=crew',
    createdBy: 'user-1',
  ...
  },
  {
    ...
    avatarUrl: 'https://api.dicebear.com/9.x/shapes/svg?seed=work',
    createdBy: 'user-1',
...
export const MOCK_GROUP_MEMBERS: GroupMember[] = [
  { id: 'gm-1', groupId: 'group-1', userId: 'user-1', role: 'organizer', joinedAt: Date.now() - 30 * 86400000, displayName: 'Alex Rivera' },
